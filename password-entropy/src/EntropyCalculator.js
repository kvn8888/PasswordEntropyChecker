    ...
    render() {
        ...
        return (
            <div className="Tool">
                ...
                <h3>Compare to</h3>
                <div className="tabs">
                    <button className={this.state.activeTab === "AES-128" ? 'active' : ''} onClick={() => {
                        this.setActiveTab('AES-128');
                        this.setState({entropy_specification: 128})
                    }}>AES 128
                    </button>
                    <button className={this.state.activeTab === "AES-256" ? 'active' : ''} onClick={() => {
                        this.setActiveTab('AES-256');
                        this.setState({entropy_specification: 256})
                    }}>AES 256
                    </button>
                    <button className={this.state.activeTab === "tab3" ? 'active' : ''} onClick={() => {
